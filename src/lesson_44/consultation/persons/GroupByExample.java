...
public class GroupByExample {
    ...
    public static void main(String[] args) {
        ...
        Map<K, List<T> - как правило, результат будет в виде Map
         */
    ...
    private static void task1() {
        ...
        // Ключом будет название отдела, значением - список сотрудников этого отдела
        // (список сотрудников, у которых поле department равно этому ключу)
        ...
        // Необходимо получить список зарплат в каждом отделе
