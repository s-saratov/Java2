...
public class StringExample {
    ...
    public static void main(String[] args) {
        ...
        // Результат работы метода мы можем сохранить и в ту же самую переменную, переписав её значение
        ...
        // Различные варианты склеивания / объединения строк

        // Конкатенация
        String concatStr = str1 + str2 + str3;
        System.out.println("concatStr: " + concatStr);

        // Конкатенация vs математическая операция сложения
        System.out.println(1 + 3);

        // "4"
        //         1 + 3 = сложение -> 4 + " : " = конкатенация -> "4 : " + 2 = конкатенация -> "4 : 2"
        ...
        // Конкатенация 2
        String concatStr2 = string.concat(str2);
        concatStr2 = concatStr2.concat(str3);
        System.out.println("concatStr2: " + concatStr2);

        // Цепочка методов
        String concatStr3 = str1.concat(str2).concat(str3).concat("!"); // (str 1 + str2) + str3 + "!"
        ...
        String subString = digits.substring(2); // Выделить подстроку со второго индекса и до конце строки
        System.out.println("subString: " + subString);
        System.out.println("digits " + digits); // Изначальная строка остаётся неизменной

        String subString2 = digits.substring(2, 7); // Взять символы со 2-го (включительно) по 7-й не включительно. [2:6)
