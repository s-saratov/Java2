...
public class PersonApp {
    ...
    public static void main(String[] args) {
        ...
        // Из какой-то части приложения (например, из слоя view) приходит ID Person-а.
        // Мне нужно его найти в моем "хранилище"
        int id = 3;
        ...
        // Есть метод, нужно выдать список Person с возрастом больше 25
