...
public class MethodsExample {
    ...
    public static void main(String[] args) {
        ...
        // ПЕРЕГРУЗКА методов
        /*
        В пределах одного класса может существовать два и более метода с одинаковыми именами,
        ...
        // Написать метод, который выводит на экран числа от X до Y
        printNumbers(5, 10);
        printNumbers("Java", 1);
        printNumbers(1, "Python");
