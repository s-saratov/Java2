...
//        }
        ...
        // Запускается бесконечный цикл. Для цикла for ни один из блоков не является обязательным
        ...
        for (int i = 1; i < 7; i++) {
            if (i == 5) continue; // continue - прервать текущую итерацию цикла и перейти к следующей итерации
            // Мы перейдём в блок изменения переменных, потом в блок проверки условия
