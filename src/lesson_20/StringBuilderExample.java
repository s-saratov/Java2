...
public class StringBuilderExample {
    ...
    public static void main(String[] args) {
        ...
        /*
        StringBuilder - это класс в Java, предназначенный для эффективного создания и модификации
        изменяемых последовательностей символов.
         */

        // Конструктор перегружен. Он может быть пустым, может принимать String
        ...
        sb3.replace(6, 11, "Java"); // верхняя граница не включтельно
